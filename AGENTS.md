...
- トップページ本文ブロックは `content/home-text.json` を講師編集用の正本とし、`node scripts/build_home_content.mjs --write` で `index.html` と `content_master_v1.md` に同期する。
- `content_master_v1.md` は公開仕様スナップショットとして扱い、単独手編集で確定しない。
