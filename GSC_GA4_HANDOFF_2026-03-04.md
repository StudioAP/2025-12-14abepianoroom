...
## 10) 期限付き運用チェック（必須）
- T+1日: GSC Pages / GA4 Realtime の初回反映確認
- T+3日: GSCインデックス推移 / GA4 Key event継続確認
- T+7日: GSC Performance（クエリ・CTR・平均順位）確認
- T+14日: 初期運用レビュー完了（課題と改善案を確定）
...
|---|---|---|---|---|---|
| GSC 所有権確認 | PASS/FAIL/保留 | 反映待ち/権限不足/計測未到達/設定不一致 | 具体策 | 日時 | 画像URL |
| sitemap送信 | PASS/FAIL/保留 | 反映待ち/権限不足/計測未到達/設定不一致 | 具体策 | 日時 | 画像URL |
| URL検査 | PASS/FAIL/保留 | 反映待ち/権限不足/計測未到達/設定不一致 | 具体策 | 日時 | 画像URL |
| GA4 Realtime | PASS/FAIL/保留 | 反映待ち/権限不足/計測未到達/設定不一致 | 具体策 | 日時 | 画像URL |
| GA4 DebugView | PASS/FAIL/保留 | 反映待ち/権限不足/計測未到達/設定不一致 | 具体策 | 日時 | 画像URL |
| Key event設定 | PASS/FAIL/保留 | 反映待ち/権限不足/計測未到達/設定不一致 | 具体策 | 日時 | 画像URL |
