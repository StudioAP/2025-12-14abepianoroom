...
try {
    ...
    addCheck("canonical", new RegExp(`<link rel="canonical" href="${CANONICAL_URL.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")}">`).test(indexSource), CANONICAL_URL);
    ...
    addCheck("sitemap loc", sitemapSource.includes(`<loc>${CANONICAL_URL}</loc>`), CANONICAL_URL);
